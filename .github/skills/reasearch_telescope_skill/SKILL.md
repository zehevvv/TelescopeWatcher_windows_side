---
name: telescopeproject
description: >
  Use this skill when the user asks any general question about the DIY telescope
  project: hardware specs, optics, cameras, filters, 3D-printed parts, motor
  control, networking, Raspberry Pi setup, or astrophotography/observing topics
  related to this rig. Keywords: telescope, optics, camera, IMX291, SC2210,
  motor, Arduino, Raspberry Pi, filter, eyepiece, focal length, astrophotography,
  aperture, magnification, UVC, IR cut, MJPEG, guide camera, refractor.
---
...
See copilot-instructions.md for full details. Key points:
